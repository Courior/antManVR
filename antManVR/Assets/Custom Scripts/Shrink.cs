namespace ANTMAN
{
	...
	public class Shrink : MonoBehaviour {
		...
		private void Start()
		{
			...
			GetComponent<VRTK_ControllerEvents>().TouchpadReleased += new ControllerInteractionEventHandler(DoShrink);

		}

		private void DoShrink(object sender, ControllerInteractionEventArgs e){
				status.shrunk = true;
